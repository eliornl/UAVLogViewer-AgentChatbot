...
REQUIRED_TABLE_FIELDS: List[str] = [
    "table",
    "columns",
    "description",
    "anomaly_hint",
...
MISSING_FIELDS_ERROR: str = (
    "Missing required fields {fields} in telemetry schema for table {table}"
)
...
INVALID_EXAMPLE_TYPE_ERROR: str = (
    "Invalid example value type for {table}.{column}: expected {expected}"
)
    ...
    },
    {
        ...
        "columns": [
            ...
            },
            {
                ...
                "data_type": "int",
                "unit": "millimeters",
                "description": "Altitude relative to takeoff",
                "nullable": False,
            },
            {
                "name": "vx",
            ...
            },
            {
                ...
                "data_type": "int",
                "unit": "cdeg",
                "description": "Heading in centidegrees",
                "nullable": False,
            },
        ],
    ...
    },
    {
        ...
        "columns": [
            ...
            },
            {
                ...
                "data_type": "int",
                "unit": None,
                "description": "Bitmap of present sensors",
                "nullable": False,
            },
            {
                ...
                "data_type": "int",
                "unit": None,
                "description": "Bitmap of enabled sensors",
                "nullable": False,
            },
            {
                ...
                "data_type": "int",
                "unit": None,
                "description": "Bitmap of sensor health",
                "nullable": False,
            },
            {
                "name": "load",
                "data_type": "int",
                "unit": "c%",
                "description": "System load in centipercent",
                "nullable": False,
            },
            {
            ...
            },
            {
                ...
                "data_type": "int",
                "unit": "c%",
                "description": "Communication drop rate",
                "nullable": True,
            },
            {
                "name": "errors_comm",
    ...
    },
    {
        ...
        "columns": [
            ...
            },
            {
                ...
                "data_type": "int",
                "unit": None,
                "description": "Raw value for channel 1",
                "nullable": False,
            },
            {
                "name": "chan2_raw",
                "data_type": "int",
                "unit": None,
                "description": "Raw value for channel 2",
                "nullable": False,
            },
            {
                "name": "chan3_raw",
                "data_type": "int",
                "unit": None,
                "description": "Raw value for channel 3",
                "nullable": False,
            },
            {
                "name": "chan4_raw",
                "data_type": "int",
                "unit": None,
                "description": "Raw value for channel 4",
                "nullable": False,
            },
            {
                "name": "chan5_raw",
                "data_type": "int",
                "unit": None,
                "description": "Raw value for channel 5",
                "nullable": True,
            },
            {
                "name": "chan6_raw",
                "data_type": "int",
                "unit": None,
                "description": "Raw value for channel 6",
                "nullable": True,
            },
            {
                "name": "chan7_raw",
                "data_type": "int",
                "unit": None,
                "description": "Raw value for channel 7",
                "nullable": True,
            },
            {
                "name": "chan8_raw",
                "data_type": "int",
                "unit": None,
                "description": "Raw value for channel 8",
                "nullable": True,
            },
            {
                "name": "rssi",
    ...
    },
    {
        ...
        "columns": [
            ...
            },
            {
                ...
                "data_type": "int",
                "unit": None,
                "description": "Horizontal position uncertainty",
                "nullable": True,
            },
            {
                "name": "epv",
    ...
    },
    {
        ...
        "columns": [
            ...
            },
            {
                ...
                "data_type": "int",
                "unit": "cA",
                "description": "Current battery draw",
                "nullable": False,
            },
            {
                "name": "battery_remaining",
...
def validate_telemetry_schema(metadata: List[TableMetadata]) -> None:
    ...
    for meta in metadata:
        ...
        if not all(key in meta for key in REQUIRED_TABLE_FIELDS):
            ...
            raise ValueError(
                MISSING_FIELDS_ERROR.format(fields=missing_fields, table=table_name)
            )

        # Validate anomaly_hint
        if (
            not isinstance(meta["anomaly_hint"], str)
            or not meta["anomaly_hint"].strip()
        ):
        ...
        for col in meta["columns"]:
            ...
            if not all(key in col for key in REQUIRED_COLUMN_FIELDS):
                ...
                raise ValueError(
                    MISSING_COLUMN_FIELDS_ERROR.format(
            ...
            if col["data_type"] not in ALLOWED_DATA_TYPES:
                ...
                raise ValueError(
                    INVALID_DATA_TYPE_ERROR.format(
                        data_type=col["data_type"], table=table_name, column=col_name
                    )
                )
            ...
            if not isinstance(col["nullable"], bool):
                ...
                raise ValueError(
                    INVALID_NULLABLE_ERROR.format(table=table_name, column=col_name)
                )
            ...
            if col["data_type"] == "int" and not isinstance(example_value, int):
                ...
                raise ValueError(
                    INVALID_EXAMPLE_TYPE_ERROR.format(
                        table=table_name, column=col_name, expected="int"
                    )
                )
            if col["data_type"] == "float" and not isinstance(example_value, float):
                ...
                raise ValueError(
                    INVALID_EXAMPLE_TYPE_ERROR.format(
                        table=table_name, column=col_name, expected="float"
                    )
                )
            if col["data_type"] == "str" and not isinstance(example_value, str):
                ...
                raise ValueError(
                    INVALID_EXAMPLE_TYPE_ERROR.format(
                        table=table_name, column=col_name, expected="str"
                    )
                )
            if col["data_type"] == "list[int]" and not (
                ...
                raise ValueError(
                    INVALID_EXAMPLE_TYPE_ERROR.format(
                        table=table_name, column=col_name, expected="list[int]"
                    )
                )
